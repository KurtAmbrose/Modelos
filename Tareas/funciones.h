 ...
 * 
 * @date Última actualización: 21 de Febrero del 2024
*/
...
/**
 * @brief Función que devuelve un valor de real y contiene una operación matemática para resolver por euler
 * @param Float: t
 * @param Float: w
 * @param Float: h
